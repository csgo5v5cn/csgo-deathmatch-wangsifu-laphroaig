...
stock players_Fade(clientIndex)
{
    ...
    PbSetInt(message, "duration", g_iConfig_SpawnFade_Duration);
    PbSetInt(message, "hold_time", g_iConfig_SpawnFade_HoldDuration);
    PbSetInt(message, "flags", 0x0001 | 0x0008);
    PbSetColor(message, "clr", g_iConfig_SpawnFade_Color);
    EndMessage();
}
