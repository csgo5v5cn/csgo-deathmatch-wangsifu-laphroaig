...
stock weapons_Build()
{
    ...
    weapons_Add(.weaponEntityName = "weapon_m4a1",          .weaponName = "M4A1",           .weaponType = weapons_type_Primary,  .weaponSkinTeam = CS_TEAM_CT,   .weaponDefinitionIndex = 16,   .weaponReloadTime = 3.4, .weaponPerBulletReload = 0,.weaponClipSize = 30,   .weaponOriginalClipSize = 0, .weaponAmmoMax = 90);
    ...
    weapons_Add(.weaponEntityName = "weapon_p250",          .weaponName = "P250",           .weaponType = weapons_type_Secondary, .weaponSkinTeam = CS_TEAM_NONE, .weaponDefinitionIndex = 36,  .weaponReloadTime = 2.5, .weaponPerBulletReload = 0, .weaponClipSize = 13,  .weaponOriginalClipSize = 0, .weaponAmmoMax = 52);
    weapons_Add(.weaponEntityName = "weapon_cz75a",         .weaponName = "CZ75-Auto",      .weaponType = weapons_type_Secondary, .weaponSkinTeam = CS_TEAM_CT,   .weaponDefinitionIndex = 63,  .weaponReloadTime = 2.5, .weaponPerBulletReload = 0, .weaponClipSize = 12,  .weaponOriginalClipSize = 0, .weaponAmmoMax = 12);
    ...
    weapons_Add(.weaponEntityName = "weapon_tec9",          .weaponName = "Tec-9",          .weaponType = weapons_type_Secondary, .weaponSkinTeam = CS_TEAM_T,    .weaponDefinitionIndex = 30,  .weaponReloadTime = 2.7, .weaponPerBulletReload = 0, .weaponClipSize = 32,  .weaponOriginalClipSize = 0, .weaponAmmoMax = 120);
...
stock weapons_GivePlayerItem(clientIndex, String:weaponEntityName[], weaponId=NO_WEAPON_SELECTED)
{
    ...
    if(weaponId > NO_WEAPON_SELECTED && skinTeam != CS_TEAM_NONE && weaponId != weapons_FindIdFromEntity(weaponEntity))
    {
        ...
        skinTeam = skinTeam == CS_TEAM_CT ?  CS_TEAM_T : CS_TEAM_CT;
        
        new origTeam2 = player_FakeTeamSwitch(clientIndex, skinTeam);
        
        origTeam = (origTeam == CS_TEAM_NONE)? origTeam2 : origTeam;
        
        weaponEntity = GivePlayerItem(clientIndex, weaponEntityName);
    }
